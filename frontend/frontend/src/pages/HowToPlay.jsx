    ...
    <div className="max-w-3xl mx-auto p-8 bg-white my-8 rounded-lg shadow-sm">
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <ul className="list-disc pl-8 space-y-2">
            <li>
              <strong>Click a Square:</strong> Select a cell to enter a letter
            </li>
            <li>
              <strong>Click a Clue:</strong> Highlights the corresponding cells
              in the grid
            </li>
            <li>
              <strong>Tab Key:</strong> Move to the next cell in the current
              direction
            </li>
            <li>
            ...
            <li>
              <strong>Enter Key:</strong> Switch between Across and Down
              orientation
            </li>
          </ul>
        </section>
